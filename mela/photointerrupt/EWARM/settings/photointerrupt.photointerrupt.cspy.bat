...
"C:\Program Files\IAR Systems\Embedded Workbench 9.0\common\bin\cspybat" -f "C:\Users\Jin\Programme\univ\mela\photointerrupt\EWARM\settings\photointerrupt.photointerrupt.general.xcl" --backend -f "C:\Users\Jin\Programme\univ\mela\photointerrupt\EWARM\settings\photointerrupt.photointerrupt.driver.xcl" 
...
"C:\Program Files\IAR Systems\Embedded Workbench 9.0\common\bin\cspybat" -f "C:\Users\Jin\Programme\univ\mela\photointerrupt\EWARM\settings\photointerrupt.photointerrupt.general.xcl" "--debug_file=%~1" --backend -f "C:\Users\Jin\Programme\univ\mela\photointerrupt\EWARM\settings\photointerrupt.photointerrupt.driver.xcl" 
